...
class KpsHelper:
    ...
    def create_sts_request(self, security_context, headers, created, expires, msg_uuid):
        try:
            ...
            return {"error": "Service access error"}
